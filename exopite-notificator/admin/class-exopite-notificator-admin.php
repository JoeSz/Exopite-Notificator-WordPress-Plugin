...
class Exopite_Notificator_Admin {
    ...
    public function get_template_fields() {
        ...
        $template_fields = array(
            ...
            'user-agent'    => $client['name'] . " | " . $client['version'] . " | " . $client['os'] . " | " . $client['platform'],
    ...
    public function new_comment( $id, $comment ) {
        ...
        if ( ! isset( $options['metabox'] ) || $options['metabox'] == 'yes' ) {
            ...
            // Get post/page meta
            $post_meta = get_post_meta( $comment->comment_post_ID, $this->plugin_name );
    ...
    public function post_or_page( $post_id, $post, $update ) {
        ...
        if ( ! isset( $options['metabox'] ) || $options['metabox'] == 'yes' ) {
            ...
            $post_meta = get_post_meta( $post_id, $this->plugin_name );
